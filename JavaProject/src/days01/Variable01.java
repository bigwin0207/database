...
// 쉽게 말해 필요에 의해 기본자료형(int, double, char 등)외에 그들을 그룹화하여 새롭게 정의한 자료형 입니다.
...
public class Variable01 {
	...
	public static void main(String[] args) {
		...
		Scores std1 = new Scores(); //std1 : 참조변수 new Scores() : 인스턴스  // 두개를 합쳐서 객체라 한다.
		// new Scores() 에 의해서 Heap 영역에 필요한 만큼 메모리를 확보하고 그 주소를 참조변수 std1에 전달합니다.
		
		
		//String str = "Korea" ; // String 은 클래스
