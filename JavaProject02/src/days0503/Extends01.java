...
// 클래스들간의 상속( Extends )
// 다수개의 클래스들이 중복되는 멤버변수 및 멤버 메소드를 갖고 있는 경우
...
// 중복되는 멤버변수들 이나 메소드들 등 그들의 생성코드를 구성요소로한 부모클래스를  생성
class Student1 extends Person{
	String strNum;
}
// 부모의 멤버들은 상속한 클래스에는 별도의 언급이 없어도 부모의 멤버변수/메소드가 있는걸로 인식됩니다.
...
// extends 에 의해 상위클래스의 모든 멤버가 하위클래스의 이동(상속, 물려받은걸로)한걸로 인식되어
