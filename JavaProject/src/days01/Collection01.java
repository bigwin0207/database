...
// Map 클래스를 상속받은 HashMap 또는 HashTable 또한 못지 않게 사용빈도수가 높고 중요하게 사용됩니다.
...
public class Collection01 {
	...
	public static void main(String[] args) {
		...
		// Vector 와 ArrayList 저장은 int 형이 아닌 Integer(클래스) 형 데이터(객체)가 저장됩니다.
		...
		//int b = a.get(0); //Object 형태를 정수형으로 넣으려 해서 오류 발생
