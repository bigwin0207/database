...
<article>
	<form>
		...
		<div class="field" style="border-top:1px dotted blueviolet;">
				<label>원가</label><div><fmt:formatNumber value="${productVO.price1}"/>원</div>
		</div>
		<div class="field" style="border-top:1px dotted blueviolet;">
				<label>판매가</label><div><fmt:formatNumber value="${productVO.price2}"/>원</div>
		</div>
		<div class="field" style="border-top:1px dotted blueviolet;">
				<label>마진</label><div><fmt:formatNumber value="${productVO.price3}"/>원</div>
		</div>
		<div class="field" style="border-top:1px dotted blueviolet;">
				<label>상세설명</label><div><pre>${productVO.content}</pre></div>
		</div>
		<div class="field" style="border-top:2px solid blueviolet; border-bottom:2px solid blueviolet;">
				<label>상품이미지</label>
		...
		<div class="btn">
			...
			<input type="button" value="목록" onClick="location.href='shop.do?command=adminProductList'">
		</div>
	</form>
</article>
