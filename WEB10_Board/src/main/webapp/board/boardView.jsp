...
<div id="main_container">
	...
	<div class="board">
		...
		<div class=field  style="margin-bottom:15px;">
			...
			<div class="text" style="font-size:140%;flex:1.5;"><pre>${board.content}</pre></div>
			...
			<div class="text" style="flex:2;">
				<c:choose>
					...
					<c:otherwise>
						<img src="images/${board.savefilename}" width="250" />
					</c:otherwise>
				</c:choose>			
			</div>
		</div>
		...
		<div class="reply">
			...
			<form action="board.do" name="reply">
				...
				<div class="reply_row">
					...
					<div class="reply_col"><input type="text" name="content1" size="75"></div>
					<div class="reply_col">
