...
<form method="post" name="frm">
	<div class="tb">
		...
		<div class="row">
			...
			<div class="coltitle" style="flex:1;'">주문일</div>
		</div>
		<c:forEach items="${orderList}" var="orderVO">
			<div class="row">
				...
				<div class="col" style="flex:1; text-align:center;">${orderVO.mname}</div>
				<div class="col" style="flex:1; text-align:center;">${orderVO.pname}</div>
				<div class="col" style="flex:1; text-align:center;">${orderVO.quantity}</div>
				<div class="col" style="flex:1; text-align:center;">${orderVO.zip_num}</div>
				<div class="col" style="flex:4; text-align:center;">${orderVO.address1} ${orderVO.address2}</div>
				<div class="col" style="flex:1; text-align:center;"><fmt:formatDate value="${orderVO.indate}"/></div>
			</div>
		</c:forEach>
				<div class="row">
					<div class="col">
