						...
						<form name="cartFrm" method="post">
							<h2> 주문자 정보 </h2>
									<div class="tb" style="margin-bottom:20px;">
											...
											<div class="row">
												<div class="coltitle"><fmt:formatDate value="${orderDetail.indate}" type="date"/></div>
												<div class="coltitle">${orderDetail.oseq}</div>
												<div class="coltitle">${orderDetail.mname}</div>
												<div class="coltitle"><fmt:formatNumber value="${totalPrice}" type="currency"/></div>												
											</div>
											<div class="row">
												<div class="coltitle" style="flex:1;">배송주소</div>
												<div class="coltitle" style="flex:4;">${orderDetail.zip_num} ${orderDetail.address1} ${orderDetail.address2}</div>											
											</div>
											<h3> 주문 상품 정보 </h3>
												<div class="tb">
														<div class="row">
