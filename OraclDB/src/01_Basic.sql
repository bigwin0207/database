...
--MongoDB,Access 등
-- 현재 출시되어 데이터베이스로 활용되는 제품들 : 오라클, MySQL, MSSQL, MariaDB, MongoDB, Access등
...
-- Alter : 이미 생성되어 있는 테이블 또는 뷰, 사용자등의 구조를 수정하기 위한 명령
-- Drop : 이미 생성되어 있는 테이블 또는 뷰, 사용자등을 삭제하기 위한 명령
